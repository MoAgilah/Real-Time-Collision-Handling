...
void Application::HandleUpdate(float dt)
{
	...
	//debug cycle in spiral order left -> up -> right -> down
	...
	/*unfortunately didnt manage to get spiral counter to work
	as i couldn't work out when to decrement cycleCom and it was taking too much time
	...
	*/
	...
	//cycle through the four heightmap for testing poly intersection
	if (this->IsKeyPressed('M'))
	{
		if (!ChangeHeightMap)
		{
