...
public:
	...
	//a check to see if the spheres chosen position if occupied
	bool OccupiedPosition(XMFLOAT3 pos, int index);
private:
	static unsigned int numOfBall;		//a variable defining the number of ball's to be dropped
